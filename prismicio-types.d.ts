...
type CaseStudyDocumentDataSlicesSlice = ArticleSlice;
...
export interface IntegrationsSliceDefaultPrimaryIntegrationItem {
  /**
   * Icon field in *Integrations → Default → Primary → Integration*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **API ID Path**: integrations.default.primary.integration[].icon
